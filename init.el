...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (lsp-javacomp lsp-java company-lsp lsp-python lsp-mode counsel linum-relative ivy atom-dark-theme workgroups2 winum which-key smex projectile monokai-alt-theme magit ido-completing-read+ flycheck-color-mode-line flx-ido evil-leader company-jedi color-theme-sanityinc-tomorrow beacon ag))))
(custom-set-faces
